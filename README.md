...
- [CLI](#cli)
  - [Options](#options)
  - [Example with a loader plugin for processing node and ES6 dependencies](#example-with-a-loader-plugin-for-processing-node-and-es6-dependencies)
  - [Example including eslint support](#example-including-eslint-support)
  - [Example Passing in options to bit-loader-js](#example-passing-in-options-to-bit-loader-js)
  - [Example printing the generated CLI settings](#example-printing-the-generated-cli-settings)
- [API](#api)
...
### Example with a loader plugin for processing node and ES6 dependencies

```
$ bitbundler --src src/main.js --dest dest/out.js --loader [ --name bit-loader-js ]
```

### Example including eslint support

```
$ bitbundler --src src/main.js --dest dest/out.js --loader [ [ --name bit-loader-js ] [ --name bit-loader-eslint ] ]
```

### Example Passing in options to bit-loader-js

```
$ bitbundler --src src/main.js --dest dest/out.js --loader [ [ --name bit-loader-js --options [ --umd ] ] [ --name bit-loader-eslint ] ]
```

### Example printing the generated CLI settings

- Handy for debugging

```
$ bitbundler --print --src src/main.js --dest dest/out.js --loader [ [ --name bit-loader-js --options [ --umd ] ] [ --name bit-loader-eslint ] ]
```
