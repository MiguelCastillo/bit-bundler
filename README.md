...
- **`--export-names`** { boolean } (false) - Export node modules by name when bundling node modules. Useful when bundling node modules such as jquery, reactjs, immutablejs, and you want to be able to import them via their names from your application bundle.
